"""
Contains some additional cleaning to the technical cleaning and the transformers used for the pipeline
"""
...
class DomainCleaner(BaseEstimator, TransformerMixin):
    """Transformer doing some additional cleaning" """
...
class FeatureSelector(BaseEstimator, TransformerMixin):
    """Transformer used select a subset of features(numerical vs. categorical)"""
...
class RegroupeCreateCategoryAutre(BaseEstimator, TransformerMixin):
    """Transformer regroup categories with less than categor_min_threshold
