"""
Module to create the pipeline, find the optimal classifier using hyperparameter optimization, 
...
def create_data_pipeline():
    """create the pipeline taking into account specific processing according to the feature type"""
...
def create_preprocessing_pipeline():
    """create the pipeline cleaning the data and adding new features"""
...
def train(df):
    """Train, tune and save a random forest model in a pickle.
